...
public class SendMailUtil {
	...
	public void sendMailOrder(Order order) {
		...
		List<OrderDetail> listOrderDetails = this.orderDetailService.findOrdersDetailByOrder(order);
		...
		this.sendMailService.queue(order.getUser().getEmail(), "Đặt hàng thành công", content.toString());
	...
	public void sendMailOrderSuccess(Order order) {
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		this.sendMailService.queue(order.getUser().getEmail(), "Thanh toán thành công", content.toString());
	...
	public void sendMailOrderDeliver(Order order) {
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		this.sendMailService.queue(order.getUser().getEmail(), "Đơn hàng đang được giao đến bạn", content.toString());
	...
	public void sendMailOrderCancel(Order order) {
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		this.sendMailService.queue(order.getUser().getEmail(), "Huỷ đơn thành công", content.toString());
	...
	static String HEADERDELIVER = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #f3eded;\" bgcolor=\"#f3eded\">\r\n"
			...
			+ "                    <tr>\r\n"
			+ "                        <td align=\"center\" valign=\"top\" style=\"font-size:0; padding: 35px;\" bgcolor=\"#f3eded\">\r\n"
			+ "                            <div style=\"display:inline-block; max-width:50%; min-width:100px; vertical-align:top; width:100%;\">\r\n"
			+ "                                <table align=\"left\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width:300px;\">\r\n"
			+ "                                    <tr>\r\n"
			+ "                                        <td align=\"left\" valign=\"top\" style=\"font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 800; line-height: 48px;\" class=\"mobile-center\">\r\n"
			+ "                                            <img src=\"https://res.cloudinary.com/martfury/image/upload/v1702619025/users/ywzynqdyd8q2odujx3qx.png\" width=\"220px\"/>\r\n"
			+ "                                        </td>\r\n" + "                                    </tr>\r\n"
			+ "                                </table>\r\n" + "                            </div>\r\n"
			+ "                            \r\n" + "                        </td>\r\n" + "                    </tr>\r\n"
			+ "                    <tr>\r\n"
			...
			+ "                                        <img src=\"https://res.cloudinary.com/martfury/image/upload/v1702619025/users/ywzynqdyd8q2odujx3qx.png\" width=\"115\" height=\"110\" style=\"display: block; border: 0px;\" /><br>\r\n"
			+ "                                        <h2 style=\"font-size: 30px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;\"> Đang giao hàng! </h2>\r\n"
	...
	static String HEADERSUCCESS = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #f3eded;\" bgcolor=\"#f3eded\">\r\n"
			+ "    <div style=\"display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Open Sans, Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;\">\r\n"
			+ "        Giang's Ecommerce\r\n" + "    </div>\r\n"
			+ "    <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\r\n" + "        <tr>\r\n"
			+ "            <td align=\"center\" style=\"background-color: #eeeeee;\" bgcolor=\"#eeeeee\">\r\n"
	...
	static String HEADERCANCEL = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #f3eded;\" bgcolor=\"#f3eded\">\r\n"
			+ "    <div style=\"display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: Open Sans, Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;\">\r\n"
			+ "        Giang's Ecommerce\r\n" + "    </div>\r\n"
			+ "    <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\r\n" + "        <tr>\r\n"
			+ "            <td align=\"center\" style=\"background-color: #eeeeee;\" bgcolor=\"#eeeeee\">\r\n"
	...
	static String HEADER = "<body style=\"margin: 0 !important; padding: 0 !important; background-color: #f3eded;\" bgcolor=\"#f3eded\">\r\n"
			+ "        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\r\n"
			+ "            <tr>\r\n"
			+ "                <td align=\"center\" style=\"background-color: #eeeeee;\" bgcolor=\"#eeeeee\">\r\n"
			+ "                    <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width:600px;\">\r\n"
	...
	static String FOOTER = "</tr>\r\n" + "                                                </table>\r\n"
			...
			+ "                                            <p style=\"font-size: 18px; font-weight: 800; line-height: 18px; color: #f3eded;\"> Giang's Ecommerce </p>\r\n"
